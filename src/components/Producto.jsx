...
const Producto = ({ producto, botoAgregar = false, botonDisponible = false }) => {
      ...
      <div className="p-5">
        ...
        {botonDisponible && (
          <button
            ...
            className='bg-indigo-600 hover:bg-indigo-800 text-white w-full mt-5 p-3 uppercase font-bold'>Producto Agotado</button>
        )}
      </div>
    </div>
  );
